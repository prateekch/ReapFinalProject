			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<div class="col-md-10">
						...
						<table>
							<tr>
								<th colspan="3"><a href="" style="text-decoration: none">${Name}</a></th>
								<th rowspan="4"><img
						...
						<div class="panel">
							<div class="panel-heading" style="margin: -15px">
								<ul class="nav nav-tabs nav-justified" role="tablist"
									...
									<li><a href='<c:url value="Badges_Received" />'>Badges
											Received</a></li>
									<li class="active"><a
										href='<c:url value="Badges_History" />'>Badges History</a></li>
							...
							<div class="panel-body">
								<div class="row">
									<div class="row">
										...
										<div class="col-md-2">
											<select class="form-control" name="quarter"
												required="required" style="width: 100px; margin: 15px">
												<option value="Q2" selected="selected">Q1</option>
									...
									<table class="bhistory" width=100%>
										<tr>
											<th colspan="2"><strong>&nbsp;&nbsp;&nbsp;Badges
													to be shared</strong></th>
											<td>&nbsp;</td>
											<td>&nbsp;</td>
										</tr>
										...
										<tr>
											<th></th>
											<th>Current badge balance</th>
											<td>&nbsp;<strong>${OGold} ${OSilver} ${OBronze}</strong></td>
											<td>&nbsp;<strong>${GoldG} ${SilverG} ${BronzeG}</strong></td>
										</tr>
										...
										<tr>
											<th></th>
											<th>Current point balance/badge balance</th>
